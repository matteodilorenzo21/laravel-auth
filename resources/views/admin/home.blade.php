...
@section('content')
    ...
    <div class="section px-5 border-top border-secondary pt-5" id="admin-dashboard">
        <div class="row px-5 mx-5 g-2">
            <div class="col-6">
                <div class="card rounded-bottom rounded-end rounded-5 text-center" id="card-index">
            ...
            <div class="col-12">
                <div class="card rounded-top rounded-5 text-center" id="card-counter">
                    <div class="card-head p-3">
                        <h5 class="card-title"></h5>
                    </div>
                    <div class="card-body d-flex align-items-center justify-content-center">
                        <p>CURRENTLY STORED PROJECTS: <span class="fw-bold">{{ $projectCount }}</span></p>
                    </div>
                </div>
            </div>
        </div>
