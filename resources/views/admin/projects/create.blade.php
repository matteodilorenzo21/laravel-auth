            ...
            <div class="row fw-bold">
                <div class="col-6">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file"
                            class="form-control border border-secondary @error('image') is-invalid @enderror" id="image"
                            name="image" oninput="updatePreviewImage()" value="{{ old('image') }}" accept="image/*">
                    </div>
                    <div>
                        <img class="border border-secondary"
                            src="{{ old('image') ? asset('uploads/' . old('image')) : 'https://i1.wp.com/potafiori.com/wp-content/uploads/2020/04/placeholder.png?ssl=1' }}"
